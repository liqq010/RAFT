...
def save_flow(flow_save_path, vis_save_path, img_path, img, flo):
    ...
    # normalize 
    bound = 15
    flo = np.round((flo + bound) / (2. * bound) * 255.)
    flo[flo < 0] = 0
    flo[flo > 255] = 255
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', default='/home/liqq/project/699/RAFT/road_optical_flow_norm', help='path to save optical flow')
